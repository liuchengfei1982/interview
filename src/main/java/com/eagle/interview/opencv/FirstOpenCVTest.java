//package com.eagle.interview.opencv;
//
...
//		 */
//		Mat srcMat = Imgcodecs.imread("E://study//ocr//opencvimg//xiaopiao4.png");  //原始图像
//
//		/**
//		 * 2. 强原始图像转化为灰度图像
//		 */
...
////		saveJpgImage(destImage,"E://study//ocr//opencvimg//destImage.jpg");
...
////		Rect rect = new Rect(0,a,binaryMat.width(),b - a);
////		Mat resMat = new Mat(binaryMat,rect);
////		BufferedImage resImage =  toBufferedImage(resMat);
////		saveJpgImage(resImage,"E://study//ocr//opencvimg//resImage.jpg");
