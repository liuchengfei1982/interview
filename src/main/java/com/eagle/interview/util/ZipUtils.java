...
//		Path src = Paths.get("C:\\Users\\Lenovo\\Desktop\\temp\\test\\相片.zip");
//		Path target = Paths.get("C:\\Users\\Lenovo\\Desktop\\temp\\test\\output");
//		ZipUtils.unPacket(src,target);

//		Path src1 = Paths.get("C:\\Users\\Lenovo\\Desktop\\temp\\test\\毕子昊.jpg");
//		Path src2 = Paths.get("C:\\Users\\Lenovo\\Desktop\\temp\\test\\曾春堯.jpg");
//		Path src3 = Paths.get("C:\\Users\\Lenovo\\Desktop\\temp\\test\\曾烨林.jpg");
//		Path targetFile = Paths.get("C:\\Users\\Lenovo\\Desktop\\temp\\test\\output\\a.zip");
//		Path[] files ={src1,src2,src3};
//		ZipUtils.packet(files, targetFile);

		Path folder = Paths.get("C:\\Users\\Lenovo\\Desktop\\temp\\test\\一2班相片");
		Path targetFile2 = Paths.get("C:\\Users\\Lenovo\\Desktop\\temp\\test\\output\\b.zip");
		ZipUtils.packet(folder, targetFile2);
